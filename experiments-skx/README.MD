...
python ../../dealii-multigrid/scripts/large_scaling.py 4 --hpmg --quadrant
python ../../dealii-multigrid/experiments-skx/large-scaling-create-job-files.py 1024 # TODO
cd ..
```
